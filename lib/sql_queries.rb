...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal #check later
...
def selects_user_names_and_amounts_of_all_pledges_grouped_by_name_then_orders_them_by_the_amount_and_users_name
  ...
  #beginning is standard, group by asks you to reiterate with very beginning with group commands
end
